...
//$protocol = stripos($_SERVER['SERVER_PROTOCOL'], 'https') === FALSE ? 'http' : 'https';
	...
	// $url="url: ".$protocol.'://'.$host.($port != 80 ? ':'.$port : '').$query;
								$passage_ligne = "\r\n";
		$header = "From: <contact@fiches-demenagement.com>".$passage_ligne;
		$header.= "Reply-to: <contact@fiches-demenagement.com>".$passage_ligne;
		$header.= "CC: sarrahafsia.91@gmail.com;".$passage_ligne;
		$header.= "BCC: khedira.hela@gmail.com;".$passage_ligne;
	    $header.= "MIME-version: 1.0\n"; 
		$header.= "Content-type: text/html; charset= UTF-8\n"; 

//TO :t.ttransport@orange.fr 
//CC : leads@fiches-demenagement.com 
$email="sarrahafsia.91@gmail.com;";
