<?php	
	...
	$typeLogement_dep=$_POST['typeLogement'];
	...
	$req2=mysql_query("insert into client(clientB2B,type_client,nom,prenom,tel,email) values (0,'$typeClient','$nom','$prenom','$telephone','$email')");
	
	
	$idclient=mysql_insert_id();	    
	$req3=mysql_query("insert into demande(id_type,type_facturation, id_source,id_client,etablie_le,code_postale_dep,ville_dep,rqs,typeLogement_dep) 
	                              values ('$idType','11','$source','$idclient','$date_etab','$cp_dep','$ville_dep','$remarque','$typeLogement_dep')");
