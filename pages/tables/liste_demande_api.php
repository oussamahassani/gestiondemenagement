...
<head>
  ...
  <title>API | Liste demande Devis Prox 
</title>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Liste Demandes API</h3>
        ...
        $id_source=$_GET['id_source'];
				 $req=mysql_query("select * from demande,client where demande.id_client=client.id_client and demande.conf=0  and id_source='$id_source' order by demande.id_dem DESC");
