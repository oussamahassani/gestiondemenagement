...
$req2=mysql_query("select * from facturation where id = '$id';") or die( mysql_error()) ;
while($result1=mysql_fetch_array($req2))
{
$numfact=$result1['numero_Facture'];
...
<td  class="cls_005"><span class="cls_010"><strong>Facture N° '.$numfact.'</strong></span></td>
</tr>
<tr>
...
<td  class="cls_030"><span class="cls_006"><b>Devis N° :</b>'.$idd.'</span><br></td>
</tr>
...
<span class="cls_006"><b>Date</b></span>
</td>
<td style="width:60%;border: solid #D0CECE 3pt;text-align: center;">
<span class="cls_006"><b>Prestation</b></span>
</td>
<td style="width:20%;border: solid #D0CECE 3pt;padding: 0cm 5.4pt 0cm 5.4pt;text-align: center;">
<span class="cls_006"><b>Prix HT</b></span>
</td>
</tr>
<tr>
...
<td style="width:20%;border: solid #D0CECE 3pt;text-align: center;"><span class="cls_006">'.number_format($totall, 2, ",", "").'</span>
</td>
</tr>
<tr>
<td style="width:50%;text-align: center;">
...
<td style="width:20%;border: solid #D0CECE 3pt;text-align: center;"><span class="cls_006">'.number_format($reulta, 2, ",", "").'</span>
</td>
</tr>
<tr>
<td style="width:50%;text-align: center;">
...
<td style="width:20%;border: solid #D0CECE 3pt;text-align: center;"><span class="cls_006">'.number_format($rest, 2, ",", "").'</span>
</td>
</tr>
</tbody>
</table>
