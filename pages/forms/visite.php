    ...
    <section class="content-header">
     ...
     <?php
            ...
            <div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-check"></i>Création Visite reussite!</h4>

                Merci , Télecharger PDF <a target="new" href="../TCPDF-master/examples/visite.php?dem=<?php echo $_GET['demande']; ?>"><img src="icono_pdf.png" width="50">.</a>
...
<form id="form" action="insert_visite.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" onSubmit="return verif()">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
         ...
         if(isset($_GET['id_dem']))
        {?><div class="form-group">
<input name="dem" type="hidden" value="<?php echo $_GET['id_dem']; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Adresse">
	...
	$date=$j."/".$m."/".$a;
			 ...
			 ?>
                ...
                <select name="commercial" class="form-control select2" style="width: 100%;">

				<?php

				$idcom=$result['id_com'];

				 $req6=mysql_query("select * from commercial where id_com='$idcom'");

				 if($result6=mysql_fetch_array($req6)) 

			{

                 echo"<option selected value='".$result6['id_commercial']."'>".$result6['nom_com']." ".$result6['prenom_com']."</option>";   				

			}

				 $req5=mysql_query("select * from commercial");

				 while($result5=mysql_fetch_array($req5)) 

			{

                 echo"<option value='".$result5['id_commercial']."'>".$result5['nom_com']." ".$result5['prenom_com']."</option>";   				
				...
				<br><br>
				 ...
				 <div class="form-group">
                  ...
                  <textarea name="remarque" class="form-control" rows="3" placeholder="Enter ..."><?php echo $result['remarque_visite']?></textarea>
