...
function remplir()
{
        document.contact.periode_arr.value=document.contact.per1.value;
		document.contact.periode_dep.value=document.contact.per2.value;
}
function verif()
{
...
<body class="hold-transition skin-blue sidebar-mini" onLoad="remplir()">
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	$date=$j."/".$m."/".$a;
                ...
                <div class="input-group">
                  ...
                  <input name="periode_dep"  value="
                  <?php
				  $date1=$result['periode1_dep'];
				  $a=substr($date1,0,4);
				  $m=substr($date1,5,2);
				  $j=substr($date1,8,2);
				  $date1=$j."/".$m."/".$a;
				   $date2=$result['periode2_dep'];
				  $a=substr($date2,0,4);
				  $m=substr($date2,5,2);
				  $j=substr($date2,8,2);
				  $date2=$j."/".$m."/".$a;
                  ...
                  "  type="text" class="form-control pull-right" id="reservation1">
	...
	$date=$j."/".$m."/".$a;
                ...
                <div class="input-group">
                  ...
                  <input name="periode_arr"   type="text" class="form-control pull-right" id="reservation2">
                  <input name="per1" value="<?php
				  $date1=$result['periode1_dep'];
				  $a=substr($date1,0,4);
				  $m=substr($date1,5,2);
				  $j=substr($date1,8,2);
                  ...
                  <input name="per2" value="<?php
				  $date1=$result['periode_arr1'];
				  $a=substr($date1,0,4);
				  $m=substr($date1,5,2);
				  $j=substr($date1,8,2);
				  $date1=$j."/".$m."/".$a;
				   $date2=$result['periode_arr2'];
				  $a=substr($date2,0,4);
				  $m=substr($date2,5,2);
				  $j=substr($date2,8,2);
				  $date2=$j."/".$m."/".$a;
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input name="prix_ht" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Prix">
                </div>
				
				 <div class="form-group">
                  <label for="exampleInputEmail1">Montant paye</label>
                  <input name="prix_paye" type="text" class="form-control" id="exampleInputEmail1" placeholder="">
                </div>
				
				<div class="form-group">
                  <label for="exampleInputEmail1">Assurance</label>
                  <input name="assurance" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Assurance">
                </div>
            ...
            <div class="form-group">
                  ...
                  <textarea name="instruction"   class="form-control" rows="3" placeholder="Enter ..."></textarea>
                </div>
				
				 <div class="form-group">
                  <label>Remarques Affiché</label>
                  <textarea name="remarque"   class="form-control" rows="3" placeholder="Enter ..."><?php
                  echo $result['rqs'];
				  ?></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea name="remarque2" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                </div>
