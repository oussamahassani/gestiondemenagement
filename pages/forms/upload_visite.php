...
<form id="form" action="insert_upload.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" onSubmit="return verif()">
    <!-- Main content -->
          ...
          <div class="row">
            <div class="col-md-6">
			 ...
			 ?>
                ...
                <label>Source</label>
                <select name="dem" class="form-control select2" style="width: 100%;">
                 <?php
				 $req5=mysql_query("select * from demande,client where demande.id_client=client.id_client");
				 while($result5=mysql_fetch_array($req5)) 
			{
                 echo"<option value='".$result5['id_dem']."'>PAR".$result5['id_dem']." ".$result5['nom']." ".$result5['prenom']."  </option>";   				
			}
				?>
