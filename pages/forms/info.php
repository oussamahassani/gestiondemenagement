...
require_once"../../menu.php";
  ...
  <div class="content-wrapper">
    ...
    <form id="form" action="update_info.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" onSubmit="return verif()">    <!-- Main content -->
    <section class="content">

      <!-- SELECT2 EXAMPLE -->
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Modification information</h3>
        ...
        <div class="box-body">
          <div class="row">
			...
			{				
			  ...
			  <div class="form-group">
                  <label for="exampleInputEmail1">Nom Admin</label>
                  <input name="nom" type="text" class="form-control" id="exampleInputEmail1" value="<?php
                  echo $result['nom_admin'];
				  ?>" placeholder="18">
                </div>
				
                <div class="form-group">
                  <label for="exampleInputEmail1"> Prenom Admin</label>
                  <input name="prenom" type="text" class="form-control" value="<?php
