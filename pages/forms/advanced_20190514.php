            ...
            <div class="col-md-6">
			  ...
			  <label>Couleur:</label>
                ...
                <div   class="input-group my-colorpicker2">
                  ...
                  <input name="couleur" type="text" class="form-control">
            ...
            <div class="col-md-6">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input  name="prenom"  type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Prenom">
				...
				<div class="form-group">
                  ...
                  <input name="telephone"  type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Telephone">
				...
				<div class="form-group">
                  ...
                  <input name="email"  type="text" type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input name="adresse_dep" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Adresse">
				...
				<div class="form-group">
                  ...
                  <input name="cp_dep" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Code Postale">
				...
				<div class="form-group">
                  ...
                  <input name="ville_dep" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Ville">
				...
				<div class="form-group">
                  ...
                  <input name="portage_dep" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Ville">
                ...
                <div class="input-group">
                  ...
                  <input name="periode_dep"  type="text" class="form-control pull-right" id="reservation">
            ...
            <div class="col-md-6">
               ...
               <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input name="adresse_arr" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Adresse">
				...
				<div class="form-group">
                  ...
                  <input name="cp_arr" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Code Postale">
				...
				<div class="form-group">
                  ...
                  <input name="ville_arr" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Ville">
                ...
                |  Passage par fenêtre <input name="monte_arr" type="checkbox" class="flat-red" >
				...
				<div class="form-group">
                  ...
                  <input name="portage_arr" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Ville">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <input name="volume" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Volume">
				...
				<div class="form-group">
                  ...
                  <input name="distance" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Distance">
              ...
              <div class="form-group">
                ...
                <select name="prestation" class="form-control select2" style="width: 100%;">
				 ...
				 <div class="form-group">
                  ...
                  <textarea name="remarque" class="form-control" rows="3" placeholder="Enter ..."></textarea>
