...
<head>
  ...
  <title>Paris ECO | confirm Demande</title>
...
require_once"../../menu.php";
  ...
  <div class="content-wrapper">
    ...
    <form id="form" action="insert_confirm_demande.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" onSubmit="return verif()">
...
<div class="box-header with-border">
  ...
  <h3 class="box-title">Proposition devis</h3>
...
<div class="box-body">
  ...
  <div class="row">
  <table width="100%"><tr>
    <td class="col-md-4" width="35%">
    <div class="form-group"><label for="exampleInputEmail1">Prix HT</label>
    <input name="prix_ht" type="text" class="form-control" id="exampleInputEmail1" placeholder="Prix HT"></div>
    </td>
    <td class="col-md-4" width="35%">
    <div class="form-group"><label for="exampleInputEmail1">Montant payé</label>
    <input name="prix_paye" type="text" class="form-control" id="exampleInputEmail1" placeholder="Prix payé"></div>
   
    </td>
    <td class="col-md-4" width="35%">
    <div class="form-group"><label for="exampleInputEmail1">Assurance</label>
    <input name="assurance" type="text" class="form-control" id="exampleInputEmail1" placeholder="Assurance"></div>
    
    </td>
    </tr>
    <tr>
    <td class="col-md-4">
    <div class="form-group"><label for="exampleInputEmail1">Instruction</label>
    <textarea name="instruction"   class="form-control" rows="3" placeholder="Instruction ..."><?php
...
?></textarea></div>
    ...
    <td class="col-md-4">
    <div class="form-group"><label for="exampleInputEmail1">Remarques Affichées</label>
    <textarea name="remarque"   class="form-control" rows="3" placeholder="Remarques ..."><?php
...
?></textarea></div>
    ...
    <td class="col-md-4">
    <div class="form-group"><label for="exampleInputEmail1">Remarques Privées</label>
    <textarea name="remarque2" class="form-control" rows="3" placeholder="Remarques ..."><?php
...
{?>
       ...
       {  if ($result5['id_source'] == $result1['id_source']) {
...
$req6=mysql_query("select * from masterParametreValeur where idMasterParametre=2 ");
       ...
       { 
        if ($result6['id'] == $result1['id_type']) {
          
        echo '<option  value="'.$result1['id_type'].'" selected="selected">'.$result6['valeur'].' </option>';
        }
        else
