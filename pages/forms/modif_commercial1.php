...
<form id="form" action="modif_commercial2.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" onSubmit="return verif()">
    <!-- Main content -->
	...
	<?php
				 ...
				 require_once '../../connect.php';
						$id=$_GET['com'];   
				 $req=mysql_query("select * from commercial where id_commercial='$id' ");
              ...
              <div class="form-group">
			   ...
			   <div class="form-group">
				...
				<div class="form-group">
                  ...
                  echo $result['tel_com'];
				  ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter telephone">
                </div>
