	...
	siret='$Siret',date_activation='$date_activation',cronActif=$cronActif,nbMaxEnvoiLead='$nbMaxEnvoiLead',volumeMin='$volumeMin',volumeMax='$volumeMax',
	...
	$email=$_POST['email'];
	$req2=mysql_query("Update client SET clientB2B=0,type_client='$typeClient',civilite='$civilite',nom='$nom',prenom='$prenom',tel='$telephone',email='$email' where id_client='$id_client'");
