...
<table width="100%"><tr>
  ...
  <input name="prix_ht" type="text" class="form-control" id="exampleInputEmail1" placeholder="Prix HT" value="<?php
...
?>"></div>
  ...
  <input name="prix_paye" type="text" class="form-control" id="exampleInputEmail1" placeholder="Prix payé" value="<?php

echo $result['montant_paye'];
...
?>"></div>
  ...
  <input name="assurance" type="text" class="form-control" id="exampleInputEmail1" placeholder="Assurance" value="<?php
...
echo $result['duree_garde'];

?>" name="duree" type="text" class="form-control" id="exampleInputEmail1" placeholder="Durée en nbre de jours ">
