...
<form id="form" action="insert_source.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" onSubmit="return verif()">
    <!-- Main content -->
          ...
          <div class="row">
            <div class="col-md-6">
			  ...
			  <div class="form-group">
                  ...
                  <input name="nom_source" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Nom">
                </div>
				
				<div class="form-group">
                  <label for="exampleInputEmail1">Site</label>
                  <input name="site" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter site">
                </div>
