...
<head>
  ...
  <title>ParisECO | Commercial</title>
...
<form id="form" action="modif_admin2.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" onSubmit="return verif()">
    <!-- Main content -->
            ...
            <div class="col-md-6">
              <div class="form-group">
			   ...
			   <div class="form-group">
				...
				<div class="form-group">
                  <label for="exampleInputEmail1">password</label>
                  <input name="password2" type="password"  class="form-control" id="exampleInputEmail1" placeholder="confirmer password">
                </div>
