...
<div id="summernote" name="summernote" style="width:100%">
<div style="text-align:justify;">
Bonjour <?php echo $result['civilite']." ".$result['nom']." ".$result['prenom'];?>
<br />
<br />
 Suite au passage de Madame   à votre domicile , nous vous prions de trouver ci-joint notre proposition de tarif pour votre projet de déménagement en formule <?php echo $result['prestation']?>.
 ...
 <br />Vous en souhaitant bonne réception, nous vous prions de croire, <?php echo $result['civilite']?> , en l'assurance de nos salutations distinguées.
 <br />
 </div>
</div>
<br />
...
<button type="submit" class="btn btn-info pull-right" onClick="envoyer(<?php echo $result['id_devis']; ?>,<?php echo $result['id_client']; ?>,<?php echo $result['id_dem']; ?>)">Envoyer</button>
  ...
  $.ajax({
              ...
              success   : function(response){
                ...
                $.ajax({
							...
							data        : 'lienPdf='+response+'&id_devis='+identifiant +"&id_client="+ id_client +"&from="+ from+"&to="+ to+"&cci="+ cci+"&objet="+ objet +"&corps="+ corps +"&id_utilisateur="+id_utilisateur,
              beforeSend  : function(){ },
              success   : function(response){
