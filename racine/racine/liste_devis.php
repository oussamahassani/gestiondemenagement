          ...
          <div class="card-body">
            <div class="table-responsive" id="resultatRecherche">
             <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              $req=mysql_query("select *,u.nom + ' '+ u.prenom AS utilisateur,statutDevis.valeur as libelleStatutDevis, ps.valeur as libellePrestation, ts.valeur as typefacturation, tl_dep.valeur AS libelleTypeLogement_dep, tl_arr.valeur AS libelleTypeLogement_arr from demande
              INNER JOIN devis ON demande.id_dem=devis.id_demande 
              INNER JOIN client  on demande.id_client=client.id_client  
              INNER JOIN utilisateur u on u.id=id_ad_dev
            ...
            echo '<br>';
             echo 'Prix : '.$result['Prix_ht'];
                      ...
                      <td>
                    <?php
                     ECHO 'Devis '.$result['libelleStatutDevis'];
                     ?> 
                     <a href="" title ='<?php echo 'Modifié le : '.$result['dateModification'].'.Par '.$result['utilisateur'];?> '>
                           <i class="text-info ti-info"></i>...</a>
                           <?php echo '<br>';
