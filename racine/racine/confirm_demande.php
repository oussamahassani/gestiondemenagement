...
<div class="content-wrapper">
  <div class="page-title">
      <div class="row">
          <div class="col-sm-6">
              <h4 class="mb-0">Confirmation demande  N° <?php echo $_GET['id_dem']; ?></h4>
          </div>
          <div class="col-sm-6">
 ...
 <div class="row">   
      <div class="col-xl-12 mb-30">     
        <div class="card card-statistics h-100"> 
          <div class="card-body">
<form id="form" action="inc/insert_confirm_demande.php" enctype="multipart/form-data" method="post" class="validateform" name="contact" >
<?php
$id=$_GET['id_dem'];   
...
<div class="form-inline" > 
  ...
  <span class="input-group-addon">
                ...
                <input name="date_etab_devis"  class="form-control" type='text' required="required" value="<?php $date = date("d/m/Y"); echo $date;?>" id="datepicker">
 </div> 
 </div>
 </td>
 <td width="30%">
 <div class="form-inline" > 
  ...
  <span class="input-group-addon">
                ...
                <input name="date_val"  class="form-control" type='text' required="required" value="" id="datepicker">
 </div>
 </div>
 </td>
 <td width="20%">
...
<?php $req6=mysql_query("select * from masterParametreValeur where idMasterParametre=10 and id!=47 and id!=48");
...
<div class="form-inline" >  
  ...
  <div class="col-md-8" >
  <input name="prix_ttc" onchange="updPrice('ttc',this.value);"  class="form-control col-md-10"  required="required" type="number" required name="price" min="0"  step="0.01"  pattern="^\d+(?:\.\d{1,2})?$" onblur="
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)">
 ...
 <div class="form-inline" >  
  ...
  <div class="col-md-8" >
  <input name="prix_ht" onchange="updPrice('ht',this.value);"  class="form-control col-md-10"  required="required" type="number" name="price" min="0" step="0.01"  pattern="^\d+(?:\.\d{1,2})?$" onblur="
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)">
</div>
  </div>
  </td>
 ...
 <div class="form-inline" >  
  ...
  <div class="col-md-8" >
      <input name="assurance"  class="form-control col-md-10"  required="required" type="number"  name="price" min="0" step="0.01" value="30000" pattern="^\d+(?:\.\d{1,2})?$" onblur="
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)">
</div>
    </div>
    </div>
...
<div class="col-md-7" >
<input name="prix_paye"  class="form-control col-md-10"  type="number"   name="price" min="0" step="0.01"  pattern="^\d+(?:\.\d{1,2})?$" onblur="
this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)">
</div>
</div>
</td>
