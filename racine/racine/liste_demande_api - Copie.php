          ...
          <div class="card-body">
            <div class="table-responsive" id="resultatRecherche">
             <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              (SELECT count(*) FROM logService l on DATE(NOW()) = DATE(l.date_creation) 
            ...
            echo 'Volume : '.$result['volume'];
                      ...
                      <td>
                      <?php if ($result['bloquee']=='1') 
                    {   echo 'Envoi bloqué' ;
                    }
                    ?>
                    <?php 
                    /*$nbMaxEnvoiLead=0;
                    $typefacturation=$result['typefacturation'];
                    $req3=mysql_query("SELECT nbMaxEnvoiLead FROM associationTypeService WHERE id_objet=5 and code_objet='Source' and id_service=15 and id_type='$typefacturation'");
                ...
                if ($result['nbEnvoiDemande']<$nbMaxEnvoiLead) 
                {*/?> 
                <?php /*if ($result['id_demande_superdem']=='') 
                {*/?> 
                 <a class="dropdown-item" id="sendSuperdem" href="#"  onClick="confirmeEnvoiFiche('<?php echo $result['id_dem']; ?>','<?php echo $id_source; ?>',247)">Envoi Superdem</a>
                 <?php /*  }*/ ?>
                <?php /* if ($result['id_demande_pariseco']=='') 
                {*/?> 
                    <a class="dropdown-item" id="sendSuperdem" href="#"  onClick="confirmeEnvoiFiche('<?php echo $result['id_dem']; ?>','<?php echo $id_source; ?>',141)">Envoi Pari's Eco</a>
                    <?php /*  }*/ ?>
