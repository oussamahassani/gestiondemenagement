	...
	$req3=mysql_query("insert into demande(id_client_B2B,couleur,id_type, id_source,id_client,etablie_le,adresse_dep,code_postale_dep,ville_dep,habit_dep,assenceur_dep,stationnement_dep,monte_meuble_dep,portage_dep,date_dep,periode_dep,adresse_arr,code_post_arr,ville_arr,habit_arr,assenseur_arr,stationnement_arr,monte_meuble_arr,portage_arr,date_arr,periode_arr,volume,distance,id_prestation,prestation,rqs,id_admin_mod,passageFenetre_dep,passageFenetre_arr,cave_dep,cave_arr,garde_meuble_dep,garde_meuble_arr,accesVehicule_dep,accesVehicule_arr) values ('$id_client_B2B','$couleur','$idType','$source','$idclient','$date_etab','$adresse_dep','$cp_dep','$ville_dep','$habit_dep','$assen_dep','$stat_dep','$monte_dep','$portage_dep','$date_dep','$periode_dep','$adresse_arr','$cp_arr','$ville_arr','$habit_arr','$assen_arr','$stat_arr','$monte_arr','$portage_arr ','$date_arr','$periode_arr','$volume','$distance','$prestation','$prestation','$remarque','$id_admin','$passageFenetre_dep','$passageFenetre_arr','$cave_dep','$cave_arr','$garde_meuble_dep','$garde_meuble_arr','$accesVehicule_dep','$accesVehicule_arr')");

?>
<script type="text/javascript">
	document.location.href="../liste_demande.php";
