          ...
          <div class="card-body">
            <div class="table-responsive" id="resultatRecherche">
             <table id="datatable" class="table table-striped table-bordered p-0">
              ...
              LEFT JOIN masterParametreValeur  ps ON ps.id =prest
...
<button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Actions</button>
                ...
                <?php   } ?>
                 ...
                 <?php   if ($_SESSION['id_client_B2B']	==141)
                  { ?>
                 <a   class="dropdown-item" id="pdf" target="new" href="../pages/TCPDF-master/examples/creerPdfDevisParisEco.php?id=<?php echo $result['id_dem']; ?>&dev=<?php echo $result['id_devis']; ?>">PDF</a></li>
                 <?php } else { ?>
                <a   class="dropdown-item" id="pdf" target="new" href="../pages/TCPDF-master/examples/creerPdfDevisSuperDem.php?id=<?php echo $result['id_dem']; ?>&dev=<?php echo $result['id_devis']; ?>">PDF</a></li>
                ...
                <?php } ?>
                <a target="new"  class="dropdown-item" id="pdfmontant" href="../pages/TCPDF-master/examples/facturePDF3.php?id=<?php echo $result['id_devis']; ?>" >Facture</a>
            ...
            data-toggle="modal" data-target="#sendMail" !---> Envoi mail devis</a>
			    <a class="dropdown-item" id="EnvoiMailfacture"  href="envoi_factureTot.php?&dev=<?php echo $result['id_devis']; ?>" >Envoi mail facture </a>
            <?php   }?>
