...
$mois_params = (isset($_GET['dev_etabli_le'])) ? $_GET['dev_etabli_le'] : '';
...
if (isset($_SESSION['id']) && isset($_SESSION['nom_com'])) {
	if (isset($_GET['devis']) && !empty($_GET['devis'])) {
		...
		$query_list_ca = "
			...
			WHERE
				dev.id_statut = 46
				AND $cond_devis BETWEEN '$premier_jour_mois' AND '$dernier_jour_mois'
...
<div class="content-wrapper overfl-auto">
	<div class="page-title">
      	<div class="row">
			<div class="col-sm-6">
				<h4 class="mb-0">Liste des devis confirmés</h4>
			</div>
			<div class="col-sm-6">
