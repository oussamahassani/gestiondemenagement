...
<meta name="description" content="Devis - <?php echo $_SESSION['titleClient']?>" />
<meta name="author" content="xxxxxxxxxxxxxxx"/>
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
<title> Devis - <?php echo $_SESSION['titleClient']?></title>
...
<!--=================================
 ...
 <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  ...
  <div class="text-left navbar-brand-wrapper">
    <a class="navbar-brand brand-logo" href="index.html"><img src="images/<?php echo $_SESSION['logo']?>" style="width:210px;height:50px;" ></a>
    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/<?php echo $_SESSION['logo']?>" style="width:210px;height:50px;" ></a>
  </div>
  <!-- Top bar left -->
        ...
        <div class="dropdown-header">
          <div class="media">
            <div class="media-body">
              <h5 class="mt-0 mb-0"> <?php echo $_SESSION['nom_com']; ?></h5>
