	...
	$req3=mysql_query("UPDATE demande SET conf='1',id_source=$source,id_type='$idType',etablie_le='$date_etab',adresse_dep='$adresse_dep',code_postale_dep='$cp_dep',ville_dep='$ville_dep',habit_dep='$habit_dep',assenceur_dep='$assen_dep',stationnement_dep='$stat_dep',monte_meuble_dep='$monte_dep',portage_dep='$portage_dep',date_dep='$date_dep',periode_dep='$periode_dep',adresse_arr='$adresse_arr',code_post_arr='$cp_arr',ville_arr='$ville_arr',habit_arr='$habit_arr',assenseur_arr='$assen_arr',stationnement_arr='$stat_arr',monte_meuble_arr='$monte_arr',portage_arr='$portage_arr',date_arr='$date_arr',periode_arr='$periode_arr',volume='$volume',distance='$distance',id_prestation='$prestation',prestation='$prestation',rqs='$remarque',id_admin_mod='$id_admin',passageFenetre_dep='$passageFenetre_dep',passageFenetre_arr='$passageFenetre_arr',garde_meuble_dep='$garde_meuble_dep',cave_dep='$cave_dep',accesVehicule_dep='$accesVehicule_dep',garde_meuble_arr='$garde_meuble_arr',cave_arr='$cave_arr',accesVehicule_arr='$accesVehicule_arr'  where id_dem='$id_d'");
	
	$req2=mysql_query("insert into devis (id_statut,id_demande,duree_garde,Prix_ht,Prix_ttc,montant_paye,instruction,prest,assurance,remarque,id_ad_dev,devis_valable_au,devis_etabli_le) values ('$statut','$id_d','$duree','$prix_ht','$prix_ttc','$prix_paye','$instruction','$prestation','$assurance','$remarque2','$id_admin','$date_val','$date_etab_devis')");
