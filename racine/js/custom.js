...
//events.push(JSON.parse($("#contenucalendrier").html().trim()));
//alert(events);
  //var infoevents=document.contact.contenucalendrier.value;
  //alert($("#contenucalendrier").html());
  if ($('#calendar-list').exists()) {
     ...
     $('#calendar-list').fullCalendar({
      ...
      editable: true,
      eventLimit: true, // allow "more" link when too many events  //'/racine/js/info.php'
      events: events
    });
    }
}
