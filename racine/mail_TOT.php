...
function my_error_handler($error_no, $error_msg)
 ...
 $resulta=mysqli_fetch_assoc($req2);
   ...
   $objet=$_POST['objet_'];
    ...
    //   $corps = 'voila';
  $id_nom=$_POST['id_nom'];
 $lienPdf='../pages/TCPDF-master/examples/encaisement'.$id_nom.'.pdf';
 $pdfName     = "encaisement". $id_devis.".pdf";
...
$bonjour= '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<div style="display:flex; font-size:12px;">
  <div  style="text-align:center;">
     <em ><b> Cordialement </b></em><br>
...
<script type="text/javascript">
	document.location.href="envoi_factureTot.php?&dev=<?php echo $id_devis;?>";
