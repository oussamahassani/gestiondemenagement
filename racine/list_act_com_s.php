...
$mois_params = (isset($_GET['date_vis'])) ? $_GET['date_vis'] : '';
...
$id_statut_vis = (isset($_GET['id_statut_vis'])) ? $_GET['id_statut_vis'] : '';

if (isset($_SESSION['id']) && isset($_SESSION['nom_com'])) {
	if ((isset($_GET['date_vis']) && !empty($_GET['date_vis'])) && (isset($_GET['id_statut_vis']) && !empty($_GET['id_statut_vis']))) {
		...
		$query_list_ca = "
			...
			WHERE
				v.date_vis BETWEEN '$premier_jour_mois' AND '$dernier_jour_mois'
				AND u.id_type = 18
				AND v.id_statut_vis = $id_statut_vis
			ORDER BY v.date_vis
		";
...
<div class="content-wrapper overfl-auto">
	<div class="page-title">
      	<div class="row">
			<div class="col-sm-6">
				<h4 class="mb-0">Activit&eacute;s commerciales du <?php echo $premier_jour_mois . ' au ' . $dernier_jour_mois; ?></h4>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
					<li class="breadcrumb-item"><a href="#" class="default-color">Acceuil</a></li>
					<li class="breadcrumb-item active">Activit&eacute;s commerciales</li>
				</ol>
			</div>
        </div>
    </div>
