...
$mois_params = (isset($_GET['devis_etabli_le'])) ? $_GET['devis_etabli_le'] : '';
	...
	if (isset($_GET['statut_devis']) && !empty($_GET['statut_devis'])) {
		...
		$query_list_ca = "
			...
			WHERE
				...
				AND date(dev.devis_etabli_le) BETWEEN '$premier_jour_mois' AND '$dernier_jour_mois'
		";
...
<div class="content-wrapper overfl-auto">
	<div class="page-title">
      	<div class="row">
			<div class="col-sm-6">
				<h4 class="mb-0">Liste des Sources Leads</h4>
			</div>
			<div class="col-sm-6">
