...
<?php require_once '../connect.php';
   $id_devis=$_GET['id_devis'];
              ...
              $req=mysql_query("select *,p.valeur as libellePrestation,ts.valeur as typefacturation, tl_dep.valeur AS libelleTypeLogement_dep, tl_arr.valeur AS libelleTypeLogement_arr from demande
              INNER JOIN devis ON demande.id_dem=devis.id_demande 
              INNER JOIN client  on demande.id_client=client.id_client  
              INNER JOIN masterParametreValeur p  ON demande.id_prestation=p.id 
...
<br />
<br />
 Suite au passage de .........   à votre domicile , nous vous prions de trouver ci-joint notre proposition de tarif pour votre projet de déménagement en formule <?php echo $result['libellePrestation']?>.
