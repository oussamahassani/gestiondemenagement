        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">   
            <div class="main-content">
              ...
              <form id="form"  enctype="multipart/form-data" method="post"   class="form-horizontal" name="contact"  action="mail_Fact.php"> <!----> 
    
                        <div class="form-row">
                        <div class="form-group col-md-4">
						<input name="id_utilisateur"  type="hidden"  id="id_utilisateur"   value="<?php echo $_SESSION['id']; ?>">
                         <input name="idfact"  type="hidden"  id="idfact"   value="<?php echo $id_Fact; ?>">
...
<input name="objet_"  type="text" class="form-control" id="exampleInputEmail1" placeholder="OBJET"  value="SUPERDEM : <?php echo $result['civilite']." ".$result['nom']." ".$result['prenom'];?> : Facture N°( <?php echo $id_Fact ?>)">
</div>
...
<button type="submit" id="envoiyer" class="btn btn-info pull-right" onclick="envoyer(<?php echo  $id_client;?>,<?php echo $identifiant; ?>,<?php echo $id_demande; ?>)">Envoyer</button>
...
var id_utilisateur=document.getElementsByName('idfact')[0].value;
